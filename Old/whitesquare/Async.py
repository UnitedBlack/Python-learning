        ...
        async with async_playwright() as p:
            ...
            while True:
                ...
                for i, page in enumerate(self.pages):
                    ...
                    if os.path.exists(f'subs/{current_subreddit[2:]}.txt'): 
                        ...
                        with open(f'subs/{current_subreddit[2:]}.txt', 'w', encoding='utf-8') as file:
                            sub_file_content = file.write("")
                            self.previous_titles[current_subreddit[2:]] = set()
...
#             subreddit_name = part[-2]
#             self.subs_list.append(subreddit_name)
            
#             if os.path.exists(f'subs/{subreddit_name}.txt'):
#                 with open(f'subs/{subreddit_name}.txt', 'r') as f:
#                     self.previous_titles = set(line.strip() for line in f.readlines())
#             else: 
#                 with open(f'subs/{subreddit_name}.txt', 'w') as f:
#                           f.write()