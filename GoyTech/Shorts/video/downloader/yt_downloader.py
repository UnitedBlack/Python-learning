...
def download_video(url):
    ...
    if name is None:
        print("Invalid URL")
        return
    path = f"video/editor/temp/{name}.%(ext)s"
    command = ["yt-dlp", "-o", path, url]
...
if __name__ == "__main__":
    download_video("https://www.tiktok.com/@top.wildber/video/7298364418184858913")
# https://www.youtube.com/shorts/CRE_dCBVbvk
#   "https://www.tiktok.com/@top.wildber/video/7298364418184858913",