...
# Баланс, траты, добавить трату, выбрать категорию
# main page > login
# class App():
...
#                 ft.Row(
#                     controls=[
#                         ft.ElevatedButton(text="Aboba", width=300, height=200),
#                     ]
#                 )
#             )
...
#             text="Login", width=200, height=200, on_click=login_clicked, bgcolor="white"
#         )
#         page.add(
#             ft.Column(
...
#                         foreground_image_url="https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.flaticon.com%2Ffree-icon%2Fmaneki-neko_3925245&psig=AOvVaw0HwFlqh0rtm7RrumDK9i7Q&ust=1703972745875000&source=images&cd=vfe&opi=89978449&ved=0CBEQjRxqFwoTCKiEo6nPtYMDFQAAAAAdAAAAABAS"
#                     ),
